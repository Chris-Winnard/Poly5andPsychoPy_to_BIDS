To convert data for any participant (including 'extra data'), set the collectingExtraData condition ("alongsideOther", "exclusively", None) and participantNumber range in the master file (poly52bids.py), and run.
