...
"""N.b- for P05 end of cEEGrid P3 there was a trigger slightly corrupted, possibly from rise time error, but could be found from manual inspection of the .poly5 file."""
def poly52trigs_splitRecs(basePath, participantNumber, rec1, rec2, filterBufferPeriod):
    ...
    #read scalp poly5
    scalp_eeg_rec1 = poly5ToEEG(SCALP_EEG_REC1, 'scalp_rec1')
    ...
    scalp_eeg_rec2 = poly5ToEEG(SCALP_EEG_REC2, 'scalp_rec2')
    ...
    #read ceegrid poly5
    ceegrid_rec1 = poly5ToEEG(CEEGRID_REC1, 'ceegrid_rec1')
    ...
    ceegrid_rec2 = poly5ToEEG(CEEGRID_REC2, 'ceegrid_rec2')
